...
echo "8. Select the '#alerts-warning' channel"
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "📋 Using the #alerts-warning channel for all alerts:"
    echo "   - Critical alerts (🚨) will appear in #alerts-warning with red color"
    echo "   - Warning alerts (⚠️) will appear in #alerts-warning with orange color"
    echo "   - General notifications will appear in #alerts-warning"
    echo ""
