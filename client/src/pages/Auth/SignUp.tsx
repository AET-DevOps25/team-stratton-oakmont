...
const SignUp: React.FC = () => {
  ...
  // TODO [ ]: the user-auth-service in the current state lets the user also make a password of max 1 character
  // TODO [ ]: also you dont have to use an email address, if hosting, then make sure to change these settings
  return (
    <Box
      sx={{
        minHeight: "100vh",
            ...
            >
              ...
              <List dense sx={{ py: 0 }}>
                ...
                <ListItem sx={{ py: 0.5, px: 0 }}>
                  ...
                  <ListItemText
                    primary="Use your TUM email address"
                    primaryTypographyProps={{
                      variant: "body2",
                      sx: { color: "#aaa" },
                    }}
